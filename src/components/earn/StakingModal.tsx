...
import { TokenAmount, Pair, ChainId } from '@alayanetwork/uniswap-sdk'
...
import { decodeBech32Address, toBech32Address } from '@alayanetwork/web3-utils';
...
export default function StakingModal({ isOpen, onDismiss, stakingInfo, userLiquidityUnstaked }: StakingModalProps) {
  ...
  const pairContract = usePairContract(contractAddress !== '' ? contractAddress : dummyPair.liquidityToken.address)
  ...
  async function onAttemptToApprove() {
    ...
    const domain = {
      ...
      version: '1',
      chainId: chainId,
      verifyingContract: dummyPair.liquidityToken.address
    }
    const Permit = [
    ...
    const message = {
      owner: accountstr,
      spender: decodeBech32Address(stakingInfo.stakingRewardAddress),
